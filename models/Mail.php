...
class Mail
{
    ...
    public static function sendMailPasswordHasChanged($toEmail, $toName, $user){
        ...
        $mail = SimpleMail::make()
            ...
            ->setHtml()
            ->setMessage($t->{'<p>Esta &eacute; uma mensagem de seguran&ccedil;a. Voc&ecirc; alterou sua senha. Caso voc&ecirc; n&atilde;o tenha efetuado a troca de senha, por favor entre em contato
                         conosco atrav&eacute;s do endere&ccedil;o <a href="mailto:contato@solarbid.com.br">contato@solarbid.com.br</a></p>'})
            ->setWrap(78);
        $send = $mail->send();
    ...
    public static function sendMailPasswordRedefinition($toEmail, $toName, $validate){
        ...
        $mail = SimpleMail::make()
            ...
            ->setMessage('<p>Voc&ecirc; est&aacute; recebendo este e-mail devido a sua solicita&ccedil;&atilde;o de redefini&ccedil;&atilde;o de senha.<br /><br />Para gerar uma nova senha, por favor acesse a seguinte URL:</p>
                        <p><a href="http://localhost/solarbid/panel/reset-password?validate='.$validate.'">http://localhost/solarbid/panel/reset-password?validate='.$validate.'</a></p>
